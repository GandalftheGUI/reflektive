...
describe Hierarchy do
  before :each do
    employee_info = [
      {"id"=>"9431e9b0-1dce-4912-8762-25c43171e9d4", "name"=>"Bill Lumbergh", "title"=>"Vice President", "manager_id"=>nil, "department"=>"Engineering"},
      {"id"=>"d8f06abc-5782-477a-86d1-f54b97085cdb", "name"=>"Peter Gibbons", "title"=>"Manager", "manager_id"=>"9431e9b0-1dce-4912-8762-25c43171e9d4", "department"=>"Engineering"},
      {"id"=>"5afad1a9-826c-4db3-9c89-20f412aff428", "name"=>"Samir Nagheenanajar", "title"=>"Software Engineer", "manager_id"=>"d8f06abc-5782-477a-86d1-f54b97085cdb", "department"=>"Engineering"},
      {"id"=>"12f2e570-ffd7-40c4-8378-0d62a9816120", "name"=>"Michael Bolton", "title"=>"Software Engineer", "manager_id"=>"d8f06abc-5782-477a-86d1-f54b97085cdb", "department"=>"Engineering"}]
  ...
  describe 'manager_ids' do
    it 'returns the correct number of manager ideas' do
